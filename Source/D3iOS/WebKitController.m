...
-(void)setupWebView
{
    ...
    //jquery-2.2.4.js
    NSString *jquery = [NSString stringWithContentsOfURL:[[NSBundle mainBundle] URLForResource:@"jquery-2.2.4" withExtension:@".js"]encoding:NSUTF8StringEncoding error:NULL];
    
    WKUserScript *jqueryScript = [[WKUserScript alloc] initWithSource:jquery injectionTime:WKUserScriptInjectionTimeAtDocumentStart forMainFrameOnly:YES];
    
    [self addUserScriptToContentController:jqueryScript];
